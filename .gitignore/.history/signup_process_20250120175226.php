...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ville_users = trim($_POST['ville_users']);// La ville sélectionnée par l'utilisateur
    $gender = $_POST['gender'];
    ...
    if (empty($department) || empty($ville_users)) {
        die("Veuillez sélectionner un département et une ville.");
    }
   ...
   $stmt->close();
    ...
    $stmt->bind_param("ssis", $pseudo, $avatarDestination, $age, $gender);
