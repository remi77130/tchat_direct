...
salonLink.href = "/path/to/salon/" + salon.id; // Remplace "/path/to/salon/" par l'URL correcte
salonLink.textContent = salon.name + " (créé par " + salon.creator_username + ")";
salonDiv.appendChild(salonLink);
