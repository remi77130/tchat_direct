...
// Ce fichier traitera la demande de création de salon et insérera les données dans la base de données.<?php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['salon_name'])) {
    ...
    $sql = "INSERT INTO salon (name, creator_username, active_until) VALUES ('$salonName', '$creatorUsername', '$activeUntil')";
