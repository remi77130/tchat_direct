...
<head>
  ...
  <script>
    function togglePlan(option) {
      ...
      if (option === 'monthly') {
        cards[0].querySelector('.price').innerHTML = "5€/mois<span>Facturé mensuellement</span>";
...
<body>
  ...
  <div class="container">
    <div class="card">
      ...
      <p class="price">5€/mois<span>Facturé mensuellement</span></p>
      <ul class="text_abonnement">

<li>Créer jusqu'à 1 salon monétisables</p>
...
<li>Passer des appels vidéo</p>
    ...
    <div class="card">
      ...
      <li>Créer jusqu'à 2 salons monétisables</p>
      <li>Ajouter une description de profil</p>
      <li>Passer des appels vidéo</p>

</ul>
      <a href="#" class="btn">Je prend !</a>
...
<li>Créer jusqu'à 5 salons monétisables</p>
<li>Ajouter une description de profil</p>
<li>Passer des appels vidéo</p>
