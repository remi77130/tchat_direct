...
<body>
    ...
    <div class="modal" id="myModal">
        <div class="modal-content">
            ...
            <input type="text" name="name_salon_user" placeholder="Nom du salon" id="salonName">
            <label for="">Description qui accroche </label>
            <input type="text" name="description_salon_user" placeholder="Bienvenue, ici tu trouvera..." id="salonName">

            <button><a href="/salon/choix_payment_jetons.php">Créer</a></button>
        </div>
    </div>
