...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div  class="counter" id="counter"></div>
    ...
    <a href="https://buyfollowerinstagram.com/" target="_blank">
        <img src="img/tchat-direct-instagram.png" alt="Achetez des Followers Instagram" class="promotion-image">
        <h3>Visitez notre site pour acheter des followers Instagram !</h3>
    </a>
</div>
