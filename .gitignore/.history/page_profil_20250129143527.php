...
<body class="bg-gray-100 font-sans">
    ...
    <textarea id="profileDescription" maxlenght="100" placeholder="Ajoute une courte description..." 
        maxlength="100" class="w-full p-2 border rounded mb-4"></textarea>
...
<script>
    ...
    saveButton.addEventListener('click', () => {
        ...
        if (text) {
            descriptionContainer.textContent = text; // Insère le texte saisi
        } else {
