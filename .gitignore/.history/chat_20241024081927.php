...
<div class="container_profile_parent">
	...
	<p class="text_presentation_live">Bienvenue ! <?php  $usename; ?>Ici, c'est un salon en live, ce qui signifie qu'il n'y a que des membres actifs. <br>
...
<div class="salon_user"> <!-- ici, salon pour écrire des message-->
	
<div class="salon_1"></div>
