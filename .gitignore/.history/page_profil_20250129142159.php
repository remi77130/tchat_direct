...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-md mx-auto mt-6 bg-white shadow-lg rounded-lg p-4">
        ...
        <div class="text-center mt-4">
            ...
            <div class="relative">
    <textarea class="textarea_profil" id="message" maxlength="100" placeholder="Écris jusqu'à 100 caractères..."></textarea>
    <p id="counter" class="text-sm text-gray-500">100 caractères restants</p>
</div>
