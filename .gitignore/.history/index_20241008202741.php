    ...
    <head>
        ...
        <meta name="description" content="Tchat en ligne avec d'autres membres. Rejoignez le chat anonyme numéro 1 en France"/> 
  ...
  <div  class="counter" id="counter"><p>membres</p></div>
    ...
    <label for="homme">Homme</label>
        ...
        <a href="http://" target="_blank" rel="noopener noreferrer">Nous</a>
        <a href="http://" target="_blank" rel="noopener noreferrer">Noj frfvr</a>
        <a href="http://" target="_blank" rel="noopener noreferrer">CGU</a>
    </footer>
</div>
