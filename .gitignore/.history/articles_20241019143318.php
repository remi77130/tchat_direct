...
<script>
        document.getElementById('submit_comment').addEventListener('click', function () {
            ...
            .then(data => {
                ...
                // Ajouter le nouveau commentaire dans la section des commentaires sans recharger la page
                ...
                newComment.innerHTML = `<p><strong>${author}</strong> - maintenant</p><p>${comment}</p>`;
