...
// Récupérer uniquement les utilisateurs actifs (dernière activité dans les 5 minutes)
...
<section>
    ...
    <div id="user-list">
        <?php foreach ($users as $user): ?>
            <div class="user">
                <img src="<?= htmlspecialchars($user['avatar']) ?>" alt="Avatar de <?= htmlspecialchars($user['username']) ?>">
...
// Mettre à jour la liste des utilisateurs toutes les 10 secondes
