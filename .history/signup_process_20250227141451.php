...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $stmt->close();
    ...
    $sql = "INSERT INTO users (username, avatar, age, gender, ville_users, zip_code) VALUES ( ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssisss", $pseudo, $avatarDestination, $age, $gender, $ville_users, $zip_code);
