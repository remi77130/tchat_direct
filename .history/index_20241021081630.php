...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div  class="counter" id="counter"></div>
    ...
    <label for="homme">Homme</label>
                    ...
                    <div class="input-box">
                    <input type="mail" id="femme" name="gender" value="female">
                    <label for="femme">Femme</label>
    ...
    <a href="https://buyfollowerinstagram.com/" target="_blank">
        <img src="img/tcha-direct-instagram.png" alt="Achetez des Followers Instagram" class="promotion-image">
        <p>buy follower instagram</p>
    </a>
</div>
