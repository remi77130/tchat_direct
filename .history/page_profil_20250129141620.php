...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-md mx-auto mt-6 bg-white shadow-lg rounded-lg p-4">
        ...
        <div class="text-center mt-4">
            ...
            <div class="relative">
    <textarea class="textarea_profil" id="message" maxlength="10" placeholder="Écris jusqu'à 10 caractères..." 
    class="w-full p- border rounded"></textarea>
    <p id="counter" class="text-sm text-gray-500">10 caractères restants</p>
</div>
