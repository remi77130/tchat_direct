...
<body class="bg-gray-100 font-sans">
    ...
    <nav class="bg-gray-800 text-white p-4 flex items-center justify-between">
        ...
        <div class="relative">
            ...
            <div id="menuDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg">
    ...
    <div class="max-w-md mx-auto mt-6 bg-white shadow-lg rounded-lg p-4">
        ...
        <div class="flex justify-center static">
            <img src="https://via.placeholder.com/100" alt="Avatar" class="rounded-full border border-gray-300">
