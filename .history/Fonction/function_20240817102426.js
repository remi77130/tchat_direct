...
salons.forEach(salon => {
    ...
    if (salon.id && salon.name && salon.creator_username) {
        ...
        if (Number.isInteger(salon.id) && typeof salon.name === 'string' && 
            salon.name.trim() !== '' && typeof 
            salon.creator_username === 'string' && salon.creator_username.trim() !== '') {
    ...
    else {console.error("Données du salon manquantes ou incorrectes", salon);}
});
