...
if (Number.isInteger(salon.id) && typeof salon.name === 'string' && salon.name.trim() !== '' && typeof salon.creator_username === 'string' && salon.creator_username.trim() !== '') {
    const salonDiv = document.createElement('a');
    salonDiv.href = "salon_chat.php?salon_id=" + encodeURIComponent(salon.id);
