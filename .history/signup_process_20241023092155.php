...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //  $ville_users = $_POST['ville_users']; // La ville sélectionnée par l'utilisateur
    $ville_users = isset($_POST['city']) ? trim($_POST['city']) : $_POST['ville_users'];
    $country = $_POST['pays_membre'];
   ...
   $stmt->close();
    ...
    $sql = "INSERT INTO users (username, avatar, age, department, ville_users, gender, country) VALUES (?, ?, ?, ?, ?, ?, ?)";
   ...
   // $stmt->bind_param("ssisss", $pseudo, $avatarDestination, $age, $department, $ville_users, $gender);
    $stmt->bind_param("ssissss", $pseudo, $avatarDestination, $age, $department, $ville_users, $gender, $country);
