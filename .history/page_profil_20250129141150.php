...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-md mx-auto mt-6 bg-white shadow-lg rounded-lg p-4">
        ...
        <div class="text-center mt-4">
            ...
            <div class="relative">
    <textarea id="message" maxlength="200" placeholder="Écris jusqu'à 200 caractères..." class="w-full p-2 border rounded"></textarea>
    <p id="counter" class="text-sm text-gray-500">200 caractères restants</p>
</div>
