...
Sur Tchat-Direct, l'accent est mis sur la convivialité et la facilité d'accès. 
...
Rejoignez Tchat-Direct aujourd'hui et découvrez par vous-même à quel point il est simple de se 
...
<div id="beta-modal" class="modal">
    <div class="modal-content">
        ...
        <h2>Version Bêta</h2>
        <p>Bienvenue sur notre site ! Veuillez noter que le site est actuellement en version bêta, ce qui signifie que certaines fonctionnalités peuvent ne pas être totalement finalisées. Merci de votre compréhension.</p>
    </div>
</div>
    </body>
    </html>
