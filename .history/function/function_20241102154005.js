...
function setupChatEvents(userId) {
    ...
    // Supprimer tous les événements existants sur le bouton envoyer en clonant l'élément
    const newSendButton = sendButton.cloneNode(true);
    sendButton.parentNode.replaceChild(newSendButton, sendButton);

    newSendButton.addEventListener('click', () => handleMessageSend(userId, messageInput));
