...
<head>
    ...
    <style>
        ...
        /* Contenu du modal */
        .modal_description_salon-content {
...
<body>
    ...
    <button id="openModal">Description salon</button>

    <!-- Le modal -->
    <div class="modal_description_salon" id="myModal">
        <div class="modal_description_salon-content">
            <button class="modal_description_salon-close" id="modal_description_salon-closeModal">&times;</button>
            <h3>Un texte qui accroche</h3>
            <p>Ajoute une description qui donne envie de rejoindre ton salon.</p>
            <input type="text" placeholder="Nom du salon" id="salonName">
            <button id="submit_modal_description_salon">Ajouter</button>
        </div>
    </div>
    ...
    <script>
        ...
        submitSalon.addEventListener("click", () => {
            ...
            if (salonName.trim() !== "") {
                ...
                modal.style.display = "none"; // Fermer le modal après la création
            } else {
