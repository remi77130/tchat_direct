...
$query  = "SELECT * FROM users WHERE last_activity >= NOW() - INTERVAL 100 MINUTE";
    ...
    <div id="user-list">
        <?php foreach ($users as $user): ?>
            <div class="user">
                ...
                <p><?= htmlspecialchars($user['username']) ?> <?= htmlspecialchars($user['zip_code']) ?>  - <?= htmlspecialchars($user['age']) ?> ans (<?= htmlspecialchars($user['ville_users']) ?>)</p>
            </div>
        <?php endforeach; ?>
    </div>
</section>
