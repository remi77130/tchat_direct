...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $age = (int)$_POST['age'];
    $gender = $_POST['gender'];
    $ville_users = $_POSTE['ville_users'];
   ...
   $stmt->close();
    ...
    $sql = "INSERT INTO users (username, avatar, age, gender, ville_users) VALUES ( ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssiss", $pseudo, $avatarDestination, $age, $gender, $ville_users);
